...
<div class="wrapper col2">
  <div id="header">
    <div class="fl_left">
      <h1><a href="index.html">Technology News</a></h1>
      <p>Know it better
    </div>
...
<div class="wrapper col3">
  <div id="topnav">
    <ul>
       <li class="active" ><a href="TopHeadLines.jsp">Headlines</a><span></span></li>
...
<div class="wrapper col5">
  <div id="container">
    <div id="content">
      ...
      <p><strong><%  NewsApp.NewsPackage.News r=addobj.getTopHeadLines("Technology", 10);%></strong></p>
     <% for(int i=0;i<10;i++)
      {%>
     ...
     <div id="column">
      ...
      <ul id="latestnews">
          <li>
    	  <img class="imgl" src=<% out.println(r.imageLink[i]); %> alt="" width="125" height="125"></img>
    	  <p><%
    	  out.println(r.news[i]); %> </p>
    	  <p class="readmore"><%out.print("<a href=NewsDetail.jsp?id=" + r.id[i] + ">Click To Read More</a>");%></p>
    	  </li>
    	   </ul>  </div>
    </div> <%
      }
